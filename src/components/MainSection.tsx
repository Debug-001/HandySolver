                            ...
                            <form className="p-4">
                                <div key={field.id} className="mx-5 pt-2">
                                    {field.isChecked && field.inputValue && (
                                        <div className="h4">
                                            {field.heading && <h4 className="h2 pt-3 text-dark fw-bold "><u>{field.heading}</u></h4>}
                                            <p className="px-2 p-2 border-1 rounded-3 text-secondary" style={{ backgroundColor: "#fff" }}>{field.inputValue}</p>
                                        </div>
                                    )}
                                </div>
                            </form>
